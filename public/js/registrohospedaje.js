...
function InicializarLocalStorage() {
  ...
  localStorage.clear();
  if (createedit) {
    var inputsform = document.querySelectorAll(".form-control");
    ...
    localStorage.setItem("checkinputdescription", "vacio");
...
function verificarForm() {
  ...
  if (check =! 'edit') {
    ...
    checkdescripcion = localStorage.getItem("checkinputdescription");
