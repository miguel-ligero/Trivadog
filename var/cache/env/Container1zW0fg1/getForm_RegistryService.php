...
class getForm_RegistryService extends App_KernelEnvDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['form.registry'] = new \Symfony\Component\Form\FormRegistry([0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService, [
            'App\\Form\\ClientesType' => ['privates', 'App\\Form\\ClientesType', 'getClientesTypeService', true],
            'App\\Form\\ComentarioshospedajeType' => ['privates', 'App\\Form\\ComentarioshospedajeType', 'getComentarioshospedajeTypeService', true],
            'App\\Form\\HabitacionesType' => ['privates', 'App\\Form\\HabitacionesType', 'getHabitacionesTypeService', true],
            'App\\Form\\HospedajeType' => ['privates', 'App\\Form\\HospedajeType', 'getHospedajeTypeService', true],
            'App\\Form\\MultimediaType' => ['privates', 'App\\Form\\MultimediaType', 'getMultimediaTypeService', true],
            'App\\Form\\PerfilType' => ['privates', 'App\\Form\\PerfilType', 'getPerfilTypeService', true],
            'App\\Form\\ReservasType' => ['privates', 'App\\Form\\ReservasType', 'getReservasTypeService', true],
            'App\\Form\\ServiciosType' => ['privates', 'App\\Form\\ServiciosType', 'getServiciosTypeService', true],
            'App\\Form\\ServicioshabitacionesType' => ['privates', 'App\\Form\\ServicioshabitacionesType', 'getServicioshabitacionesTypeService', true],
            'App\\Form\\TipohospedajeType' => ['privates', 'App\\Form\\TipohospedajeType', 'getTipohospedajeTypeService', true],
            ...
            'App\\Form\\ComentarioshospedajeType' => '?',
            'App\\Form\\HabitacionesType' => '?',
            'App\\Form\\HospedajeType' => '?',
            'App\\Form\\MultimediaType' => '?',
            'App\\Form\\PerfilType' => '?',
            'App\\Form\\ReservasType' => '?',
            'App\\Form\\ServiciosType' => '?',
            'App\\Form\\ServicioshabitacionesType' => '?',
            'App\\Form\\TipohospedajeType' => '?',
