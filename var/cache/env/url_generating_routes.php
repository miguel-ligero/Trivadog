...
return [
    ...
    'editarAlojamiento' => [['hostid', 'providerid'], ['providerid' => null, '_controller' => 'App\\Controller\\HospedajeController::createEditHost'], [], [['variable', '/', '[^/]++', 'providerid', true], ['variable', '/', '[^/]++', 'hostid', true], ['text', '/hospedaje/alojamiento/editar']], [], []],
