...
class MultimediaRepository extends ServiceEntityRepository
{
    ...
    */
    ...
    public function getpictures($where)
    { 
        $conn = $this->getEntityManager()->getConnection();
        $sql = "SELECT * FROM multimedia WHERE $where";
    ...
    public function Save(Multimedia $picture): Multimedia
    {
    ...
    public function delete($roomid): Multimedia
    {
        $em = $this->getEntityManager();
        $em->remove($roomid);
        $em->flush();
